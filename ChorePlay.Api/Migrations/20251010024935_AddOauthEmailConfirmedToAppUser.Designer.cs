...
namespace ChorePlay.Api.Migrations
{
    ...
    [Migration("20251010024935_AddOauthEmailConfirmedToAppUser")]
    partial class AddOauthEmailConfirmedToAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChorePlay.Api.Shared.Auth.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ChorePlay.Api.Shared.Auth.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("OAuthEmailConfirmed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Ulid>", b =>
                {
                    b.HasOne("ChorePlay.Api.Shared.Auth.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Ulid>", b =>
                {
                    b.HasOne("ChorePlay.Api.Shared.Auth.AppUser", null)
                        .WithMany()
